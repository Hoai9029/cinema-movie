...
class _TmdbApi implements TmdbApi {
  ...
  Future<TmdbMovieDetailResponse> getMovieDetail(int movieId) async {
    ...
    late TmdbMovieDetailResponse _value;
    try {
      _value = TmdbMovieDetailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<TmdbCreditsResponse> getCredits(int movieId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TmdbCreditsResponse _value;
    try {
      _value = TmdbCreditsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<TmdbVideosResponse> getVideos(int movieId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TmdbVideosResponse _value;
    try {
      _value = TmdbVideosResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<TmdbMovieResponse> getSimilarMovies(int movieId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TmdbMovieResponse _value;
    try {
      _value = TmdbMovieResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
